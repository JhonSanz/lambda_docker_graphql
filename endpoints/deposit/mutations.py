...
class Mutation:
    @strawberry.field
    def add_deposit(self, quantity: float, date_deposit: str, account_id: str, money_id: str, currency: str, description: str) -> Deposit:
        id = str(uuid.uuid1())
        data = {
            'id': id,
    ...
    @strawberry.field
    def update_deposit(self, id: str, quantity: float, date_deposit: str, account_id: str, money_id: str, currency: str, description: str) -> Deposit:
        to_update = {}
