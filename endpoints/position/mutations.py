...
class Mutation:
	@strawberry.field
	def add_position(self, reference_id: str, open_date: str, close_date: str, price: float, volume: float, is_leveraged: bool, order_type: str, direction: str, asset_id: str, description: str) -> Position:
		id = str(uuid.uuid1())
		data = {
			'id': id,
	...
	@strawberry.field
	def update_position(self, id: str, reference_id: str, open_date: str, close_date: str, price: float, volume: float, is_leveraged: bool, order_type: str, direction: str, asset_id: str, description: str) -> Position:
		to_update = {}
